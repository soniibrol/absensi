			...
			<?php
				if($count > 0){
					foreach($list_approval as $row){
						...
						echo '<td style="width:15%;text-align:center;"><a href="'.base_url().'attendance/approve/'.$row['id_absen_susulan'].'" class="btn btn-default" onclick="return confirm(\'Are you sure want to approve this data?\')">Setujui</a></td>';
						echo '</tr>';
					}
				}else{
